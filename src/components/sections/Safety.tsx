  ...
  const guarantees = [
    {
      ...
      description: 'Formulario previo de límites y preferencias. Tu palabra segura siempre será respetada.',
      details: ['Entrevista previa personalizada', 'Códigos de colores claros', 'Staff entrenado en consentimiento'],
    },
    {
      icon: Shield,
      title: 'Seguridad Total',
      description: 'Protocolo de seguridad con personal presente en todo momento, sin intrusión en tu experiencia.',
    ...
    },
    {
      ...
      description: 'Experiencia guiada 100% por Inteligencia Artificial. Sin presencia física humana durante la experiencia.',
      details: ['IA especializada en consentimiento', 'Adaptación en tiempo real', 'Soporte humano disponible 24/7 desde la app'],
    },
    {
      icon: FileCheck,
  ...
  const process = [
    {
      ...
      description: 'Completás el formulario de límites y preferencias',
    },
    {
      step: 2,
      title: 'Briefing Personal',
      description: 'Conversación privada sobre códigos y palabras seguras',
    },
    {
      step: 3,
      title: 'Durante la Experiencia',
      description: 'Guiada completamente por Game Master IA automatizada. Personal humano disponible vía app ante cualquier emergencia',
    },
    {
      step: 4,
      title: 'Aftercare',
      description: 'Debriefing opcional y espacio para procesar la experiencia',
    },
  ];
    ...
    <Section id="seguridad" dark>
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
          Seguridad, Consentimiento & Privacidad
        </h2>
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-6">
          En Eroscape, el placer solo existe con cuidado. Antes de empezar, defines tus límites, eliges tu palabra segura y decides tu nivel de intensidad. Nosotros cuidamos la ambientación, la higiene y tu privacidad.
        </p>
      ...
      <div className="mb-16">
        <h3 className="text-3xl font-bold text-center text-white mb-12">Proceso de Seguridad Paso a Paso</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {process.map((item) => (
            <div key={item.step} className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 mb-4 text-white font-bold text-2xl">
                {item.step}
              </div>
      ...
      <div>
        <h3 className="text-3xl font-bold text-center text-white mb-12">Nuestras Garantías</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {finalGuarantees.map((item, index) => {
            const Icon = item.icon;
            return (
              <Card key={index} className="text-center">
                <Icon className="mx-auto text-purple-400 mb-3" size={32} />
                <h4 className="text-lg font-bold text-white mb-2">{item.text}</h4>
