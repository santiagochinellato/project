...
export default function TopBar() {
  return (
    <div className="bg-purple-900/30 backdrop-blur-sm border-b border-purple-500/20 py-2 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2">
        <p className="text-purple-200 text-sm">
          Experiencia para mayores de 18 años. Estética erótica no explícita.
        </p>
        <div className="flex items-center gap-4">
          <span className="text-purple-300 text-xs font-medium hidden md:inline">Síguenos:</span>
          <div className="flex gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-purple-300 hover:text-blue-300 transition-colors"
